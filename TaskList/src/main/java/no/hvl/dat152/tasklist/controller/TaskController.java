...
import no.hvl.dat152.tasklist.model.ResponseAddTask;
import no.hvl.dat152.tasklist.model.ResponseDeleteTask;
import no.hvl.dat152.tasklist.model.ResponseGetAllstatuses;
import no.hvl.dat152.tasklist.model.ResponseGetTask;
import no.hvl.dat152.tasklist.model.ResponseGetTasks;
import no.hvl.dat152.tasklist.model.ResponsePutTaskStatus;
...
public class TaskController {
    ...
    public @ResponseBody ResponseGetTasks getTasks() {
    ...
    public @ResponseBody ResponseGetAllstatuses getStatuses() {
    ...
    public @ResponseBody ResponsePutTaskStatus UpdatedTaskStatuses(@PathVariable Integer taskId,
    ...
    public @ResponseBody ResponseAddTask ResponseAddTask(@RequestBody Task task) {
    ...
    public @ResponseBody ResponseGetTask getTask(@PathVariable Integer taskId) {
    ...
    public @ResponseBody ResponseDeleteTask deleteTask(@PathVariable Integer taskId) {
